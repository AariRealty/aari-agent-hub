...
//
//   node mockups/build-hero.js      -> mockups/dashboard-v6-hero.html
//
...
const src=fs.readFileSync(path.join(__dirname,'dashboard-v6-hero.src.html'),'utf8');
...
const dest=path.join(__dirname,'dashboard-v6-hero.html');
