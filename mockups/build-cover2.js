...
//
//   node mockups/build-hero.js      -> mockups/dashboard-v6-cover2.html
//
...
const src=fs.readFileSync(path.join(__dirname,'dashboard-v6-cover2.src.html'),'utf8');
...
const dest=path.join(__dirname,'dashboard-v6-cover2.html');
