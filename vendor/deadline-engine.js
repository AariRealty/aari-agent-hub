/* ============================================================================
   ...
   Source   AariRealty/aari-transactions-landing · js/deadline-engine.js
   Commit   32cc6a9f4ae9e77b5082f27ead7d765ee2611403
   sha256   0efe0dad43777025e8c67a44f8eb9868a66d7486019c531459bf2fb3766f3b69
   Bytes    53858
   Pinned   2026-09-05

   The Florida deadline engine is one implementation with two surfaces: the TC
   portal computes a file's schedule from it, and so does the Hub. A second copy
   that anybody edits is a second answer to "when is inspection over", and the
   two would drift apart on the day one of them was fixed.

   So this copy is byte for byte the upstream file at the commit named above,
   with only this header in front of it. If the engine is wrong, fix it in the
   transactions repo and re-pin here at the new commit. Never patch it here.

   Verify:
     tail -n +23 vendor/deadline-engine.js | sha256sum
   asserted in build/test-deadlines.js.
   ============================================================================ */
/* ============================================================================
