  ...
  agents: [
    {
      ...
      photoUrl: 'images/agents/marlenyi-paredes.jpg',
    ...
    },
    {
      ...
      photoUrl: 'images/agents/alejandro-paredes.jpg', photoPortrait: '',
    ...
    },
    {
      ...
      title: 'Realtor®', role: 'agent',
      photoUrl: 'images/agents/odalis-mora.jpg', photoPortrait: '',
      specialties: [], marketAreas: [], languages: ['English', 'Spanish'],
      hours: '', bestFor: '', license: '', social: { instagram: '', tiktok: '' },
      fitLine: '',
      isActive: true, showInCarousel: true, pickable: true
    },
    {
      ...
      title: 'Realtor®', role: 'agent',
      photoUrl: 'images/agents/alied-machuca.jpg', photoPortrait: '',
      specialties: [], marketAreas: [], languages: ['English', 'Spanish'],
      hours: '', bestFor: '', license: '', social: { instagram: '', tiktok: '' },
      fitLine: '',
      isActive: true, showInCarousel: true, pickable: true
    },
    {
      ...
      title: 'Realtor®', role: 'agent',
      photoUrl: 'images/agents/ana-puentes.jpg', photoPortrait: '',
      specialties: [], marketAreas: [], languages: ['English', 'Spanish'],
      hours: '', bestFor: '', license: '', social: { instagram: '', tiktok: '' },
      fitLine: '',
      isActive: true, showInCarousel: true, pickable: true
    },
    {
      ...
      title: 'Realtor®', role: 'agent',
      photoUrl: 'images/agents/flavia-aguilera.jpg', photoPortrait: '',
      specialties: [], marketAreas: [], languages: ['English', 'Spanish'],
      hours: '', bestFor: '', license: '', social: { instagram: '', tiktok: '' },
      fitLine: '',
      isActive: true, showInCarousel: true, pickable: true
    },
    {
      ...
      title: 'Realtor®', role: 'agent',
      photoUrl: 'images/agents/roosevelt-sanchez.jpg', photoPortrait: '',
      specialties: [], marketAreas: [], languages: ['English', 'Spanish'],
      hours: '', bestFor: '', license: '', social: { instagram: '', tiktok: '' },
      fitLine: '',
      isActive: true, showInCarousel: true, pickable: true
