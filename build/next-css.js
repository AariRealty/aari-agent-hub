...
function build() {
  ...
  const lines = [];
  lines.push("  /* Generated by build/next-css.js from build/aari-base.css. Do not edit by");
  lines.push("     hand: run the script. Every selector is prefixed #app, which exists only");
  lines.push("     in the new Hub, so none of this can reach the build agents are on. */");
