...
async function __txLoad(){
  ...
  var active = __txRows.filter(function(t){ return t.lifecycle === 'Active'; });
  var term   = __txRows.filter(function(t){ return t.lifecycle === 'Terminated'; });
  var closed = __txRows.filter(function(t){ return t.lifecycle === 'Closed'; });
